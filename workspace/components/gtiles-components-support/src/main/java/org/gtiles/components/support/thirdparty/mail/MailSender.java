package org.gtiles.components.support.thirdparty.mail;
...
public class MailSender {
	...
	public static void main(String[] args) throws GeneralSecurityException, UnsupportedEncodingException {
        ...
        mailInfo.setMailServerHost(SmtpServer.smtp_sina.get("smtp"));  
        mailInfo.setMailServerPort(SmtpServer.smtp_sina.get("port"));
        mailInfo.setValidate(true);
        mailInfo.setFromNickName("xdemo网站");
        mailInfo.setUserName("xxx@sina.com"); // 实际发送者  
        mailInfo.setPassword("xxx");// 您的邮箱密码  
        mailInfo.setFromAddress("xxx@sina.com"); // 设置发送人邮箱地址  
        mailInfo.setToAddress("zzz@qq.com,ccc@163.com"); // 设置接受者邮箱地址  
        ...
        mailInfo.setAttachments(new ArrayList<File>(){
        	{
        		add(new File("D:\\libs\\json-1.0.jar"));
        		add(new File("D:\\libs\\ueditor-1.1.1.jar"));
        	}
        });
        // 这个类主要来发送邮件  
